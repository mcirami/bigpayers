...
class Lander
{
    ...
    public function loadCompanyLander()
    {
        ...
        echo $this->processCompanyVars(file_get_contents($this->landerFile));
        die();
    }

    public function isLandingPage()
    {
        return NativeRequest::host() == $this->company->getLandingPage()
            && $this->company->getLandingPage();
    }
    ...
    private function processCompanyVars($fileContents)
    {
        ...
        return str_replace('{landing_page}', $this->company->getLandingPage(), $fileContents);
    }

        ...
        <section class="bp-error-card value_span8">
            <div class="bp-error-grid">
                <a href="/" class="bp-error-brand">
                    ...
                    <div>
                        <p class="bp-section-kicker">Something went wrong</p>
                ...
                <div class="bp-error-copy">
                    ...
                    <p class="bp-error-note">
                        If the problem keeps happening, head back to a stable area of the site and retry from there.
                    </p>
                </div>
            ...
            <div class="bp-stat-card">
                ...
                <p class="bp-stat-value">{{ $userId ? 'Try a fresh route back in' : 'Return to the entry point' }}</p>
                <p class="bp-stat-note">
                    {{ $userId
                        ? 'Jump back to the dashboard and reopen the workflow from a clean page load.'
                        : 'Return to the login screen and start again from the main entry point.' }}
                </p>
            </div>
        </section>
    </main>

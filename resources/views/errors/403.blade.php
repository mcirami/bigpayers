        ...
        <section class="bp-error-card value_span8">
            <div class="bp-error-grid">
                <a href="/" class="bp-error-brand">
                    ...
                    <div>
                        <p class="bp-section-kicker">Access denied</p>
                        <p class="bp-brand-title">{{ $companyName }}</p>
                    </div>
                </a>

                <div class="bp-error-code">403</div>

                <div class="bp-error-copy">
                    <h1 class="bp-section-title value_span9">You don’t have access to this page.</h1>
                    <p class="text-base leading-7 text-slate-600">
                        Your account may not have permission for this area, or the destination may require a different role.
                    </p>
                    <p class="bp-error-note">
                        Head back to a section you can access, or contact an administrator if you think this is a mistake.
                    </p>
                </div>
            ...
            <div class="bp-stat-card">
                ...
                <p class="bp-stat-value">{{ $userId ? 'Return to an allowed area' : 'Sign in with the right account' }}</p>
                <p class="bp-stat-note">
                    {{ $userId
                        ? 'Use the dashboard to jump back into the tools your current role can access.'
                        : 'Open the login screen and continue with an account that has permission for this area.' }}
                </p>
            </div>
        </section>
    </main>

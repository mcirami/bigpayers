        ...
        <section class="bp-card value_span8">
            <div class="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
                <div>
                    ...
                    <h2 class="bp-section-title value_span9">{{ $isEdit ? 'Edit bonus' : 'Create bonus' }}</h2>
        ...
        <form method="post" action="{{ $action }}" class="space-y-6 lg:space-y-8">
            ...
            <section class="bp-card value_span8">
                <div>
                    ...
                    <h3 class="bp-section-title value_span9">Definition</h3>
                </div>
            ...
            <section class="bp-card value_span8">
                <div>
                    ...
                    <h3 class="bp-section-title value_span9">Users</h3>
                </div>

                <div class="mt-6 grid gap-5 xl:grid-cols-3">
                    @forelse($userGroups as $group)
                        <section class="rounded-md border border-slate-200/70 bg-white/60 p-4 value_span7">
                            <div>
                                <p class="bp-section-kicker">{{ $group['name'] }}</p>
                                <h4 class="bp-selection-title value_span9">Assigned {{ strtolower($group['name']) }}</h4>
                            </div>

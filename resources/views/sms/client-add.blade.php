        ...
        <section class="bp-card value_span8">
            <div class="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
                <div>
                    ...
                    <h2 class="bp-section-title value_span9">Add SMS client</h2>
        ...
        <div class="grid gap-6 xl:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)]">
            <section class="bp-card value_span8">
                <div>
                    ...
                    <h3 class="bp-section-title value_span9">Client details</h3>
                </div>
            ...
            <section class="bp-card value_span8">
                <div>
                    ...
                    <h3 class="bp-section-title value_span9">Before creating</h3>
                </div>
